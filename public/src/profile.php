                ...
                <div class="md:flex no-wrap md:-mx-2">
                    ...
                    <div class="w-screen md:w-3/12 md:mx-2">
                        ...
                        <div id="profile_card" class="bg-white dark:bg-gray-800 border rounded-xl border-gray-300 shadow-md p-5 dark:border-gray-700">
                            ...
                            <ul class="bg-gray-100 dark:bg-gray-800 border rounded-xl border-gray-600 p-5 text-gray-600 dark:text-gray-200 hover:text-gray-700 hover:shadow py-2 px-3 mt-3 divide-y shadow-sm">
                            ...
                            <a href="">
                                <button class="w-full block mb-7 mt-5 font-inter text-white bg-trasparent dark:hover:bg-primary-600 hover:bg-primary-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center border border-primary-600" type="button">
                                    GET IN TOUCH
                                </button>
                            </a>
                        </div>
