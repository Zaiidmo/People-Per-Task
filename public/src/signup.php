...
<body class="dark:bg-gray-900 ">
  ...
  <section class="flex justify-center m-auto items-center max-w-screen-xl py-32 dark:bg-gray-900">
    <div class="py-8 lg:py-16 px-4 w-[70%] bg-white border rounded-3xl dark: dark:bg-gray-700  ">
      ...
      <!--  Form signUp -->
      <form action="../../app/controllers/user-session.php" method="POST" class="flex flex-col items-center max-w-lg mx-auto">
        ...
        <button type="submit" name="signup" class="text-white bg-primary-600 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-bold rounded-2xl text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 tracking-widest max-w-md ">START</button>
      </form>
