          ...
          <div class="w-screen md:w-3/12 md:mx-2">
            ...
            <div id="profile_card" class="bg-white dark:bg-gray-800 border rounded-xl border-gray-300 shadow-md p-5 dark:border-gray-700">
              <div class="image overflow-hidden">
                <img
                  class="h-52 w-52 rounded-full mx-auto"
              ...
              <ul
                class="bg-gray-100 dark:bg-gray-800 border rounded-xl border-gray-600 p-5 text-gray-600 dark:text-gray-200 hover:text-gray-700 hover:shadow py-2 px-3 mt-3 divide-y shadow-sm"
              >
              ...
              <button class="border border-primary-800 ">
          ...
          <div class="w-full md:w-9/12 mx-2 h-64">
              ...
              <div class="text-gray-700 dark:text-gray-400">
                <div class="grid md:grid-cols-2 text-sm ">
                  <div class="grid grid-cols-2 ">
                    ...
                    <div class="px-4 py-2 text-gray-700 dark:text-gray-400">Jane</div>
                  </div>
                  <div class="grid grid-cols-2">
                  ...
                  <div class="grid grid-cols-2">
                    ...
                    <div class="px-4 py-2 text-gray-700 dark:text-gray-400">peoplepertask@email.com</div>
                  </div>
                  <div class="grid grid-cols-2">
            ...
            <div id="freelancer_offers" class="bg-white dark:bg-gray-800 border rounded-xl border-gray-300 p-5 dark:border-gray-700 shadow-md flex flex-col ">
              <div id="title" class="flex gap-4">
                ...
                <h3 class="text-left mr-96 text-gray-700 tracking-widest dark:text-white font-mono font-bold ">ACTIVE OFFERS</h3>
              </div>
              <div class="grid grid-cols-3 gap-10">
                <div class="w-64 mt-6 bg-white p-8 border border-gray-700 rounded-lg dark:bg-gray-800 shadow-md">
